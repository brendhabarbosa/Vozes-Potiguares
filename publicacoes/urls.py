...
urlpatterns = [
    ...
    path('excluir_texto/<int:texto_id>/', excluir_texto, name='excluir_texto'),
    ...
    path('textosporgenero/<str:genero>/', textosporgenero, name='textosporgenero'),
    ...
    path('curtir_texto/<int:texto_id>/', curtir_texto, name='curtir_texto'),
]